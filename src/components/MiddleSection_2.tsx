...
export default function MiddleSection_2() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-[#f7fbff]">
      ...
      <div className="pointer-events-none absolute left-[14%] top-[16%] h-[280px] w-[280px] rounded-full bg-[#9CF048]/20 blur-[90px]" />
      <div className="pointer-events-none absolute bottom-[14%] right-[12%] h-[340px] w-[340px] rounded-full bg-[#9CF048]/16 blur-[105px]" />
      ...
      <div className="pointer-events-none absolute left-8 top-8 z-30 hidden lg:block">
        <motion.div
          ...
          className="rounded-full border border-[#9CF048]/40 bg-white/72 px-5 py-2 text-[12px] font-black uppercase tracking-[0.12em] text-[#236000] shadow-[0_14px_34px_rgba(15,23,42,0.06)] backdrop-blur-md"
        >
          {activeTitle}
        </motion.div>
      </div>
