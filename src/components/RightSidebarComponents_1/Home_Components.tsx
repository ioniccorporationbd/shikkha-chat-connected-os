...
const sectionText = {
  bn: {
    ...
    description:
      "শিক্ষা চ্যাট শিক্ষার্থী তথ্য, পরিবার যোগাযোগ, উপস্থিতি সহায়তা, ভর্তি এবং স্কুল পরিচালনাকে একটি নির্ভরযোগ্য প্ল্যাটফর্মে যুক্ত করে। স্কুল পরিষ্কার আপডেট শেয়ার করতে পারে, পরিবার সবসময় তথ্য জানতে পারে এবং প্রতিটি শিক্ষার্থী আরও ভালো সহায়তা পায়।",
    stats: [
      {
        value: "+৭০%",
    ...
    role: "টেকনোলজি লিডার, সংযুক্ত স্কুল কমিউনিটি",
    logo: "শিক্ষা চ্যাট",
  },
  en: {
    ...
    description:
      "Shikkha Chat connects student information, family communication, attendance support, enrollment, and school operations in one trusted platform. Schools can share clear updates, families can stay informed, and every learner gets better support.",
    stats: [
      {
        value: "+70%",
