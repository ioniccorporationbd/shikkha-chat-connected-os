...
export default function SpecialPrograms() {
  return (
    <SectionPanel
      ...
      stats={[{ value: "1200+", label: "Organizations using PowerSchool for special programs" }, { value: "1.7M", label: "Student services forms completed each year" }, { value: "9M+", label: "Students supported" }]}
      quote="Two-way data flow between PowerSchool SIS and Special Programs ensures that data is always current. Teachers also get alerts for student accommodations."
      author="Paul Howard"
