...
export default function AttendanceSupport() {
  return (
    <SectionPanel
      ...
      description="Absenteeism starts with small signs long before it becomes a serious problem. Shikkha Chat Attendance Support detects those signs early and automates family outreach so staff can respond quickly and keep students on track."
      stats={[{ value: "600+", label: "Organizations using Shikkha Chat for attendance support" }, { value: "2.2M+", label: "Students supported" }, { value: "80M+", label: "Messages sent each school year" }]}
