...
const centerCards: CardItem[] = [
  ...
  },
  {
    ...
    active: true,
    color: darkColor,
    label: "Main Hiring Workflow",
    description:
      "Recruiting and HR connects hiring, onboarding, staff records, applicant tracking, and human resources workflows so schools can build stronger teams faster.",
  },
];
...
const floatingCards: CardItem[] = [
  ...
  },
  {
    ...
    description:
      "Talent Management supports employee growth, staff planning, role visibility, and people-centered school operations.",
  },
];
...
function ConnectorLine({ selectedId }: { selectedId: string }) {
  ...
  if (selectedId === "recruiting-and-hr") {
    return (
      <motion.div
