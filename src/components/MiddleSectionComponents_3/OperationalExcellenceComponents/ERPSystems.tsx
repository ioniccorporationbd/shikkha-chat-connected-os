...
const centerCards: CardItem[] = [
  {
    ...
    label: "Planning Hub",
    description:
      "Resource Planning helps school leaders align budgets, staffing, programs, and operational priorities with better visibility.",
  },
  {
    id: "erp-systems",
    title: "ERP Systems",
    ...
    label: "Main ERP Core",
    description:
      "ERP Systems connect finance, HR, purchasing, payroll, operations, and administrative workflows into one central business platform so school teams can work faster with trusted data.",
  },
];
...
const floatingCards: CardItem[] = [
  ...
  },
  {
    ...
    description:
      "Financial Strategy connects budgets, spending visibility, and finance planning with operational priorities.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Talent Management supports staff development, role planning, performance, and people-centered operational decisions.",
  },
  {
    ...
    description:
      "Recruiting and HR connects hiring, onboarding, staff records, and HR workflows with district operations.",
  },
  {
    id: "educator-support",
    ...
    label: "Staff Success",
    description:
      "Educator Support helps schools provide staff assistance, support visibility, and connected workflows for employee success.",
  },
  {
    id: "resource-planning",
    title: "Resource Planning",
    ...
    label: "Planning",
    description:
      "Resource Planning aligns people, programs, budgets, and priorities into a clearer planning process.",
  },
];
...
function ActiveErpCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="relative z-10 max-w-[120px] text-[16px] font-black leading-[1.05] tracking-[-0.04em] text-[var(--color-black)]">
        {formatTitle(t(item.title))}
      </h3>
    </motion.button>
  );
