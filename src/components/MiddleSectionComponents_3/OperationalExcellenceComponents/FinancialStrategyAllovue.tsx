...
const centerCards: CardItem[] = [
  {
    ...
    description:
      "Operational Excellence connects finance, planning, ERP, enrollment forecasting, talent, recruiting, and staff support into one smarter school operations view.",
  },
  {
    ...
    active: true,
    color: darkColor,
    label: "Main Planning Hub",
    description:
      "Resource Planning helps school leaders align people, budgets, programs, staffing, and operational priorities so every resource decision supports better outcomes.",
  },
];
...
const floatingCards: CardItem[] = [
  {
    ...
    description:
      "Financial Strategy connects budget planning, spending visibility, and school finance decisions with operational priorities.",
  },
  {
    id: "erp-systems",
    title: "ERP Systems",
    ...
    label: "Core ERP",
    description:
      "ERP Systems connect finance, HR, purchasing, operations, and administrative workflows into one central business system.",
  },
  {
    ...
    label: "Forecasting",
    description:
      "Predictive Enrollment helps schools forecast student movement, enrollment demand, staffing needs, and future resource pressure.",
  },
  {
    ...
    description:
      "Talent Management helps districts support staff growth, role planning, performance, and people-centered operational decisions.",
  },
  {
    ...
    description:
      "Recruiting and HR connects hiring, staff records, onboarding, and human resources workflows with district operations.",
  },
  {
    id: "educator-support",
    ...
    label: "Staff Success",
    description:
      "Educator Support helps schools provide staff assistance, visibility, and connected workflows that improve the employee experience.",
  },
  {
    id: "operational-excellence",
    title: "Operational Excellence",
    ...
    description:
      "Operational Excellence brings every operational system together so leaders can plan, manage, and act with confidence.",
  },
];
...
function ConnectorLine({ selectedId }: { selectedId: string }) {
  ...
  if (selectedId === "resource-planning") {
    return (
      <motion.div
