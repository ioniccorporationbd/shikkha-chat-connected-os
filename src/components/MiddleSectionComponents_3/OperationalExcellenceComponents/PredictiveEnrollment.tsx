...
const centerCards: CardItem[] = [
  {
    ...
    label: "Core ERP",
    description:
      "ERP Systems connect finance, HR, purchasing, payroll, operations, and administrative workflows into one central business platform.",
  },
  {
    ...
    active: true,
    color: darkColor,
    label: "Main Enrollment Forecasting",
    description:
      "Predictive Enrollment helps school leaders forecast student movement, enrollment demand, staffing needs, facility pressure, and future resource planning with clearer operational insight.",
  },
];
...
const floatingCards: CardItem[] = [
  ...
  },
  {
    ...
    description:
      "Recruiting and HR connects hiring, staff records, onboarding, and HR workflows with district operations.",
  },
  {
    id: "educator-support",
  ...
  },
  {
    ...
    label: "ERP Core",
    description:
      "ERP Systems connect operations, finance, purchasing, payroll, HR, and administration through one trusted business system.",
  },
];
    ...
    >
      ...
      <div
        className={[
          ...
          isPredictive ? "font-black" : "font-normal",
          isSingleWord
...
function ConnectorLine({ selectedId }: { selectedId: string }) {
  ...
  if (selectedId === "predictive-enrollment") {
    return (
      <motion.div
