  ...
  bn: {
    ...
    cards: {
      ...
      "family-engagement": {
        ...
        label: "অভিভাবক সেকশন",
        description:
          "পরিবারের সম্পৃক্ততা যোগাযোগ, উপস্থিতি, শিক্ষার্থী তথ্য এবং পরিবারের সহায়তাকে একটি সংযুক্ত প্ল্যাটফর্মে নিয়ে আসে।",
      },
    },
  },
  en: {
...
function ActiveCommunicationsCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="relative z-10 max-w-[132px] text-[15px] font-semibold leading-[1.05] tracking-[-0.04em] text-current">
        {item.title}
      </h3>
    ...
    <div className="relative z-10 mx-auto flex min-h-[640px] w-full max-w-3xl flex-col justify-center px-5 py-10 md:px-8 lg:hidden">
      <div className="rounded-[30px] border-[3px] border-[var(--color-primary)] bg-[var(--color-white)] p-5 shadow-[0_24px_70px_color-mix(in_srgb,var(--color-primary)_14%,transparent)] backdrop-blur-xl">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {cards.map((card) => {
            const active =
              selectedCard?.id === card.id || card.id === "communications";
            ...
            <div className="absolute left-1/2 top-[-66px] z-20 -translate-x-1/2">
              <button
                ...
                onClick={() => {
                  ...
                  scrollRightSidebarTo("communications");
                }}
                className={[
