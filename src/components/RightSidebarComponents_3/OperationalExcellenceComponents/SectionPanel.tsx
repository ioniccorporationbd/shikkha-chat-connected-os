  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-[calc(100vh-112px)] flex-col justify-center pb-10 pt-8 sm:pt-9">
        ...
        <p className="section-description mt-4 max-w-[455px] font-medium leading-[1.65] text-[color-mix(in_srgb,var(--color-black)_78%,var(--color-white))] ">
          {description}
        </p>
          ...
          <div className="mt-8 overflow-hidden rounded-[18px] bg-[var(--color-secondary)] p-5 shadow-[0_18px_45px_color-mix(in_srgb,var(--color-primary)_14%,transparent)] sm:p-6">
            ...
            <div className="relative mt-6 flex min-h-[130px] items-center justify-center overflow-hidden rounded-2xl">
              ...
              <div className="relative z-10 flex flex-col items-center gap-5 sm:flex-row sm:gap-8">
                ...
                <div className="brand-logo-text flex h-[84px] w-[140px] items-center justify-center rounded-xl bg-[color-mix(in_srgb,var(--color-white)_46%,transparent)] px-4 text-center font-black uppercase leading-tight text-[var(--color-black)]">
                  {logo || "School Logo"}
                </div>
              </div>
            </div>
            {author ? (
              <div className="mt-6">
                ...
                {role ? (
                  <p className="author-role-text mt-1 font-medium leading-6 text-[color-mix(in_srgb,var(--color-black)_72%,var(--color-white))]">
                    {role}
                  </p>
                ) : null}
              </div>
