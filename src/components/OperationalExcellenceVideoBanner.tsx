...
export default function OperationalExcellenceVideoBanner() {
  ...
  return (
    <section ref={sectionRef} id="operational-excellence-video" className="relative overflow-visible bg-white">
      <style jsx>{`
        @keyframes textStart {
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <motion.video
            ...
            src="https://www.powerschool.com/wp-content/uploads/2026/03/tour-operational-excellence-hero.mp4"
            autoPlay
            muted
            loop
            playsInline
        ...
        <div className="pointer-events-none absolute inset-0 z-10 bg-gradient-to-r from-[#ECC6FE]/18 via-transparent to-transparent" />
        <div className="pointer-events-none absolute inset-0 z-10 bg-gradient-to-l from-[#5B1276]/18 via-transparent to-transparent" />
        ...
        <div className="absolute inset-0 z-30 flex h-screen items-center justify-center px-6">
          ...
          >
            ...
            <h2 className="text-[32px] font-black leading-[1.06] tracking-[-0.05em] text-white drop-shadow-[0_8px_26px_rgba(0,0,0,0.24)] md:text-[50px] lg:text-[58px]">
              More power to run smarter school operations
            </h2>
