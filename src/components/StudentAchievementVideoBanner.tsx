...
export default function StudentAchievementVideoBanner() {
  ...
  return (
    <section ref={sectionRef} id="student-achievement-video" className="relative overflow-visible bg-white">
      <style jsx>{`
        @keyframes textStart {
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 z-10 bg-gradient-to-r from-[#9CF048]/18 via-transparent to-transparent" />
