...
const centerCards: CardItem[] = [
  {
    ...
    description:
      "Learning Management connects assignments, resources, classroom activity, and digital learning workflows with student achievement data.",
  },
  {
    ...
    active: true,
    color: darkColor,
    label: "Main Instruction Hub",
    description:
      "Curriculum & Instruction helps schools connect standards, lesson planning, teaching resources, assessment outcomes, and classroom delivery into one professional instructional workflow.",
  },
];
...
const floatingCards: CardItem[] = [
  {
    ...
    label: "Achievement View",
    description:
      "Student Achievement gives educators one connected view of learning growth, progress, support needs, and future readiness.",
  },
  {
    ...
    label: "Teaching Tools",
    description:
      "Classroom Solutions supports daily teaching, classroom organization, learning activities, and teacher-friendly workflows.",
  },
  {
    ...
    label: "Assessment Data",
    description:
      "Assessment connects student mastery, progress measurement, and performance data with better instructional decisions.",
  },
  {
    ...
    label: "Support Planning",
    description:
      "Student Intervention helps schools respond to learning gaps with targeted support, progress tracking, and connected intervention steps.",
  },
  {
    id: "mtss",
    title: "MTSS",
    ...
    description:
      "MTSS connects academic, behavior, and wellbeing support into a coordinated multi-tier framework.",
  },
  {
    id: "behavior-support",
    title: "Behavior Support",
    ...
    label: "Wellbeing",
    description:
      "Behavior Support helps schools understand behavior patterns and connect wellbeing support with student learning context.",
  },
  {
    ...
    label: "Future Readiness",
    description:
      "College, Career & Life Readiness connects academic progress with future goals, pathway planning, and student readiness.",
  },
  {
    id: "cclr-naviance",
    title: "CCLR Naviance",
    ...
    description:
      "CCLR Naviance supports student pathway planning, readiness goals, future exploration, and connected success tracking.",
  },
];
...
function MiniCard({
  ...
  const isCurriculum = item.id === "curriculum-instruction";
    ...
    >
      ...
      <div
        className={[
          ...
          isCurriculum ? "font-black" : "font-normal",
          isSingleWord
  ...
  return (
    <motion.button
      ...
      className={[
        ...
        "transition-shadow duration-300 hover:shadow-[0_32px_84px_color-mix(in srgb, var(--color-primary) 22%, transparent),0_0_0_7px_color-mix(in srgb, var(--color-secondary) 14%, transparent)]",
        "focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--color-secondary)_40%,transparent)] focus-visible:ring-offset-2",
      ].join(" ")}
    >
...
function ConnectorLine({ selectedId }: { selectedId: string }) {
  ...
  if (selectedId === "curriculum-instruction") {
    return (
      <motion.div
