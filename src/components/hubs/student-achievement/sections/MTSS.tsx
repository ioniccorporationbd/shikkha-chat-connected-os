...
const centerCards: CardItem[] = [
  {
    ...
    label: "Support Planning",
    description:
      "Student Intervention helps schools identify learning gaps, create support plans, and track student progress with connected intervention workflows.",
  },
  {
    id: "mtss",
    title: "MTSS",
    ...
    active: true,
    color: darkColor,
    label: "Main Multi-Tier Support",
    description:
      "MTSS connects academic, behavior, attendance, and wellbeing support into one multi-tier system so schools can respond earlier, coordinate teams, and support every student with better visibility.",
  },
];
...
const floatingCards: CardItem[] = [
  ...
  },
  {
    ...
    label: "Wellbeing",
    description:
      "Behavior Support connects behavior patterns, wellbeing actions, and student support workflows with school teams.",
  },
  {
...
function ActiveMtssCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="relative z-10 max-w-[120px] text-[18px] font-black leading-none tracking-[-0.04em] text-[var(--color-black)]">
        {item.title}
      </h3>
    </motion.button>
  );
